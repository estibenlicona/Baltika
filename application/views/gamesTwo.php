<body>
  ...
  <div class="container-fluid">
    ...
    <form action="<?=base_url('games/saved/'.$g->id_home.'/'.$g->id_away.'/'.$g->league.'/two')?>" method="post">
    <div class="row">
      ...
      <div class="col-1 p-2 text-right">
        <?php  if ($g->played == 1): ?>
        <a href="<?=base_url('games/playedTwo/'.$g->id_home.'/'.$g->id_away.'/'.$g->league.'/0') ?>" class="btn btn-primary btn-sm">
          <i class="opciones-nav icono-btn material-icons md-18 light600">check</i>
        </a>
        <?php endif; ?>
        <?php if ($g->played == 0): ?>
        <a href="<?=base_url('games/playedTwo/'.$g->id_home.'/'.$g->id_away.'/'.$g->league.'/1') ?>" class="btn btn-danger btn-sm">
