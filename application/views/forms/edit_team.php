      ...
      <form action="<?=base_url('team/edit/'.$id)?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input name="nombre" onkeyup="mayus(this);" type="text" class="form-control rounded"  value="<?=$team->nombre?>" placeholder="Username" aria-describedby="inputGroupPrepend" required>
          </div>
        </div>
        <div class="form-group">
